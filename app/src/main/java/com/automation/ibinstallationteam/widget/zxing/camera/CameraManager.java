...
package com.automation.ibinstallationteam.widget.zxing.camera;
...
import com.automation.ibinstallationteam.widget.zxing.camera.open.OpenCameraInterface;
...
public class CameraManager {
	...
	public void changeFlashLight(boolean openOrClose){
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
			changeFlashLight_New(openOrClose);
		else
			changeFlashLight_Old(openOrClose);
	}

	@TargetApi(Build.VERSION_CODES.N)
	@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
	public void changeFlashLight_New(boolean openOrClose){
	...
	public void changeFlashLight_Old(boolean openOrClose){
		Camera.Parameters parameters = camera.getParameters();
		if(openOrClose) parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);//开启
		else parameters.setFlashMode(Camera.Parameters.FLASH_MODE_OFF);//关闭
