package com.automation.ibinstallationteam.widget.searchview;
...
//        searchDrawable = getResources().getDrawable(R.drawable.search);
        clearDrawable = getResources().getDrawable(R.drawable.ic_searchview_clear);
        searchDrawable = getResources().getDrawable(R.drawable.ic_searchview_search);
